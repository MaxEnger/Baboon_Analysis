...
lc_test <- raster("inst/extdata/ESACCI-LC-L4-LCCS-Map-300m-P1Y-2015-v2.0.7.tif")
```

### EVI - Vegetation Index
```{r}
EVI_cv <- raster("V:/Commons/Baboon/SDM_data/cv_01_05_1km_uint16_0_1.tif")
EVI_con <- raster("V:/Commons/Baboon/SDM_data/Contrast_01_05_1km_uint32_0_1.tif")
EVI_hom <- raster("V:/Commons/Baboon/SDM_data/Homogeneity_01_05_1km_uint16_0_1.tif")
```
...
```{r}
olive.me <- maxent(modelEnv, olivetrain, factors = 'lc_resample') # using only training data
```
